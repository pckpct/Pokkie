...
$config['hosts'] = array('nlehv10w8ls003.corpad.dsm-group.com');
$config['ports'] = array(389);
$config['basedn'] = 'OU=EU-NL-STD00,OU=Users,OU=Accounts,DC=CORPAD,DC=DSM-GROUP,DC=COM';
$config['login_attribute'] = 'samaccountname';
$config['proxy_user'] = 'corpad\SA_Migrationcenter';
$config['proxy_pass'] = 'Dsm*9999';
